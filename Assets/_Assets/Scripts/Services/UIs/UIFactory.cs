...
namespace _Assets.Scripts.Services.UIs
{
    public class UIFactory
    {
        ...
        private UIFactory(ConfigProvider configProvider, IObjectResolver objectResolver, LoadingCurtainIconProvider loadingCurtainIconProvider, MainMenuProvider mainMenuProvider)
        {
        ...
        public async UniTask<InGameBackground> CreateInGameUI()
        {
            ...
            ui.GetComponent<NextSuikaUI>().Init();
            ui.GetComponent<InGameTimer>().Init();
            ui.GetComponent<ScoreUI>().Init();
            await ui.GetComponent<InGameBackground>().Init();
