...
namespace _Assets.Scripts.Misc
{
    ...
    {
        public static async UniTask<Sprite> CreateSprite(string relativePath, bool highQuality = false)
        {
        ...
        public static async UniTask<Sprite> CreateSpriteFromStreamingAssests(string relativePath, bool highQuality = false)
        {
            using (var webRequest = UnityWebRequestTexture.GetTexture(relativePath))
            {
                ...
                imageTexture.Compress(highQuality);
